...
"""
Exceptions that may happen in all the BaseLib code.
"""


class WebDriverException(Exception):
    """
    Base BaseLib exception.
    """
...
class NoSuchElementException(WebDriverException):
    ...
    If you encounter this exception, you may want to check the following:
        ...
        * Element may not yet be on the screen at the time of the find operation,
          (webpage is still loading) see selenium.BaseLib.support.wait.WebDriverWait()
...
class UnexpectedAlertPresentException(WebDriverException):
    ...
    Usually raised when when an expected modal is blocking BaseLib form executing any
    more commands.
    """
